...
function Footer () {
    return (
        <>
        <footer className="footer sm:footer-horizontal bg-green-900 text-white p-10">
  <aside>
   <img
               src={Logo}
               alt="Logo"
  ...
  <nav>
    <h6 className="font-bold text-green-200 text-lg">ABOUT US</h6>
    <a className="link link-hover">Steel Produt</a>
    <a className="link link-hover">Location</a>
    <a className="link link-hover">Careers</a>
    <a className="link link-hover">FAQs</a>
  </nav>
  <nav>
    <h6 className="font-bold text-green-200 text-lg">CONTACT US</h6>
      <p>UCMT VALENZUELA</p>
      <p>Tel No:</p>
      <p>Mobile No:</p>
      <p>Email:</p>
  ...
  <nav>
    <h6 className="font-bold text-green-200 text-lg">CUSTOMER SERVICE</h6>
