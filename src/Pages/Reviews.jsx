          ...
          <div className="max-w-6xl w-full mx-auto px-8 sm:px-10 lg:px-12 py-6">
            <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
              ...
              {user ? (
               ...
               <button 
  onClick={handleLogin} 
  className="btn bg-white text-black border-[#e5e5e5] flex items-center justify-center space-x-2 px-4 py-2 rounded-lg shadow-md transition-all duration-300 ease-in-out transform hover:scale-105"
>
  <svg 
  ...
  <span className="ml-2 text-lg font-semibold">Login with Google</span>
</button>
              )}
            </div>
          </div>
